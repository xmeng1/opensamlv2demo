...
public class SamlToolKit
{
    ...
    public static void main(String[] args) {
        try {
            ...
            Assertion assertion = SamlToolKit.buildDefaultAssertion(input);
     ...
     */
    public static Attribute buildStringAttribute(Object name, Object value, XMLObjectBuilderFactory builderFactory) throws ConfigurationException
    {
        ...
        attrFirstName.setName((String) name);
        ...
        attrValueFirstName.setValue((String) value);
    ...
    public static Assertion buildDefaultAssertion(SAMLInputContainer input)
    {
        try
        {
            ...
            SAMLObjectBuilder nameIdBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(NameID.DEFAULT_ELEMENT_NAME);
            ...
            SAMLObjectBuilder confirmationMethodBuilder = (SAMLObjectBuilder)  SamlToolKit.getSAMLBuilder().getBuilder(SubjectConfirmationData.DEFAULT_ELEMENT_NAME);
            ...
            SAMLObjectBuilder subjectConfirmationBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(SubjectConfirmation.DEFAULT_ELEMENT_NAME);
            SubjectConfirmation subjectConfirmation = (SubjectConfirmation) subjectConfirmationBuilder.buildObject();
            subjectConfirmation.setSubjectConfirmationData(confirmationMethod);

            // Create the Subject
            SAMLObjectBuilder subjectBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(Subject.DEFAULT_ELEMENT_NAME);
            ...
            SAMLObjectBuilder authStatementBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(AuthnStatement.DEFAULT_ELEMENT_NAME);
            ...
            SAMLObjectBuilder authContextBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(AuthnContext.DEFAULT_ELEMENT_NAME);
            AuthnContext authnContext = (AuthnContext) authContextBuilder.buildObject();

            SAMLObjectBuilder authContextClassRefBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(AuthnContextClassRef.DEFAULT_ELEMENT_NAME);
            ...
            // Builder Attributes
            SAMLObjectBuilder attrStatementBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(AttributeStatement.DEFAULT_ELEMENT_NAME);
            ...
            SAMLObjectBuilder doNotCacheConditionBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(OneTimeUse.DEFAULT_ELEMENT_NAME);
            Condition condition = (Condition) doNotCacheConditionBuilder.buildObject();

            SAMLObjectBuilder conditionsBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(Conditions.DEFAULT_ELEMENT_NAME);
            Conditions conditions = (Conditions) conditionsBuilder.buildObject();
            conditions.getConditions().add(condition);

            // Create Issuer
            SAMLObjectBuilder issuerBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(Issuer.DEFAULT_ELEMENT_NAME);
            Issuer issuer = (Issuer) issuerBuilder.buildObject();
            issuer.setValue(input.getStrIssuer());

            // Create the assertion
            SAMLObjectBuilder assertionBuilder = (SAMLObjectBuilder) SamlToolKit.getSAMLBuilder().getBuilder(Assertion.DEFAULT_ELEMENT_NAME);
